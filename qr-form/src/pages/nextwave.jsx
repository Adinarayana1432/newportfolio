...
// import IMG1 from '../pages/Image/sathesh1.png';
import IMG2 from '../pages/Image/sathish2.jpg';
import IMG3 from '../pages/Image/sathish3.jpg';
import IMG4 from '../pages/Image/sathish4.jpg';
import IMG5 from '../pages/Image/kerala4.jpg';
import IMG6 from '../pages/Image/kerala5.jpg';
import IMG7 from '../pages/Image/kerala6.jpg';
import { FaFacebook, FaInstagramSquare, FaLinkedin } from 'react-icons/fa';
import { FaSquareWhatsapp } from 'react-icons/fa6';
import '../pages/nextwave.css';
    ...
    <div className='bg'>
      ...
      <div className='footer-container'>
        ...
        <div className="gfooter-image">
          <img className="image1" src={'./adhithya.jpg'} alt='Photographer'/>
      ...
      <div className='welcome-container' ref={homeRef}>
        <div className='marquee-container'>
          <div className='marquee-content'>
            <img className="image-s" src={IMG2} alt='Photography'/>
            <img className="image-s" src={IMG3} alt='Photography'/>
            <img className="image-s" src={IMG4} alt='Photography'/>
            <img className="image-s1" src={IMG5} alt='Photography'/>
      ...
      <div className='about-content' ref={aboutRef}>
        {currentPage === 'about' && (
          <div className='about-me'>
            <h2>About Me</h2>
            <img className="image-me" src='./adhi.jpg' alt='Photographer'/>
          ...
          <div className='services-content'>
            ...
            <div className='services-matter'>
              <div className='matter-div1'>
                <img className='s-images1' src={'./s1.jpg'} alt='Anupuma' />
                <h3>Portrait Photography:</h3>
                <p>Professional and personalized portrait sessions for individuals, families, and groups.</p>
              </div>

              <div className='matter-div2'>
                <img className='s-images2' src={'./s2.jpg'} alt='' />
                <h3>Landscape Photography:</h3>
                <p>Capturing the beauty of nature and cityscapes with high-quality images.</p>
              </div>

              <div className='matter-div3'>
                <img className='s-images3' src={'./s3.jpg'} alt='' />
                <h3>Event Photography:</h3>
                <p>Documenting special events, including weddings, parties, and corporate functions.</p>
              </div>

              <div className='matter-div4'>
                <img className='s-images4' src={'./s4.jpg'} alt='' />
